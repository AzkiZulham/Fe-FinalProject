      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 py-4 sm:py-6 lg:py-8">
        <div className="max-w-4xl mx-auto px-3 sm:px-4 lg:px-6 xl:px-8">
              ...
              <Form className="space-y-6 sm:space-y-8">
                    ...
                    {({ remove, push }) => (
                      <div className="space-y-4 sm:space-y-6">
                        ...
                        <button
                          ...
                          className="w-full py-3 sm:py-4 border-2 border-dashed border-gray-300 rounded-lg sm:rounded-xl text-gray-600 hover:border-blue-400 hover:text-blue-600 hover:bg-blue-50 transition-all duration-200 flex items-center justify-center gap-2 sm:gap-3"
                        >
                          <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                          </svg>
                          <span className="text-sm sm:text-base font-medium">Tambah Tipe Kamar</span>
                        </button>
                      </div>
                    )}
                  </FieldArray>
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-end">
                  <button
                    ...
                    className="px-6 sm:px-8 py-2.5 sm:py-3 bg-gray-100 text-gray-700 rounded-lg sm:rounded-xl hover:bg-gray-200 transition-colors duration-200 text-sm sm:text-base font-medium"
                  >
                    Batal
                  </button>
                  <button
                    ...
                    className="px-6 sm:px-8 py-2.5 sm:py-3 bg-blue-600 text-white rounded-lg sm:rounded-xl hover:bg-blue-700 disabled:bg-blue-400 disabled:cursor-not-allowed transition-colors duration-200 text-sm sm:text-base font-medium flex items-center gap-2"
                  >
                    {isSubmitting ? (
                      <>
          ...
          <Modal
            ...
            title="Berhasil!"
          >
            <p>Properti berhasil ditambahkan.</p>
          ...
          <Modal
            ...
            title="Batalkan Penambahan Properti"
          >
            <p>Apakah Anda yakin ingin membatalkan? Semua data yang telah diisi akan hilang.</p>
