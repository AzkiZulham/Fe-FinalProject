...
import { Eye, EyeOff, Lock, Loader2, CheckCircle2, XCircle, AlertCircle, ShieldCheck, Info } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogHeader,
        ...
        <div className="p-5 bg-gradient-to-r from-orange-50 to-amber-50 rounded-xl border border-orange-200 shadow-sm hover:shadow-md transition-all duration-300">
          ...
          <ul className="text-sm text-orange-700 space-y-2">
            <li className="flex items-start gap-2 p-2 rounded-lg hover:bg-white/50 transition-colors cursor-default">
              ...
              <span>Gunakan kombinasi huruf, angka, dan simbol yang unik</span>
            </li>
            <li className="flex items-start gap-2 p-2 rounded-lg hover:bg-white/50 transition-colors cursor-default">
              <div className="w-1.5 h-1.5 bg-orange-500 rounded-full mt-1.5 flex-shrink-0"></div>
            ...
            <li className="flex items-start gap-2 p-2 rounded-lg hover:bg-white/50 transition-colors cursor-default">
              <div className="w-1.5 h-1.5 bg-orange-500 rounded-full mt-1.5 flex-shrink-0"></div>
              <span>Jangan gunakan password yang sama untuk banyak akun</span>
            </li>
            <li className="flex items-start gap-2 p-2 rounded-lg hover:bg-white/50 transition-colors cursor-default">
              <div className="w-1.5 h-1.5 bg-orange-500 rounded-full mt-1.5 flex-shrink-0"></div>
              <span>Ganti password secara berkala setiap 3-6 bulan</span>
            </li>
          </ul>
        </div>
      </div>
